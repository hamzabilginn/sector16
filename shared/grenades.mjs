...
export function createGrenade(p,time,id){const d=direction(p.yaw,p.pitch);return {id,owner:p.id,team:p.team,name:p.name,x:p.x,y:eye(p),z:p.z,vx:d.x*14,vy:d.y*14+3,vz:d.z*14,explodeAt:time+2.2};}
