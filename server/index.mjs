...
const server=http.createServer(async(req,res)=>{try{
 ...
 if(url.pathname==='/api/health')return json(res,200,{ok:true,game:'Sector 16',version:'1.6.1',rooms:rooms.size,players:[...peers].filter(p=>p.room).length,tickRate:60});
